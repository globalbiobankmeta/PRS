...
option_list <- list(
  ...
  make_option(c("-f", "--file_pattern"), type = "character", default = NULL, help = "a regex pattern for score files (*profile or *sscore generated by Plink) with multiple chromosomes"),
